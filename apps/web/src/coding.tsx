  ...
  return (
    <section className="coding-page" aria-labelledby="coding-agent-title">
      <header className="coding-page-header">
        <div><span className="eyebrow">v1.0 · изолированная среда</span><h1 id="coding-agent-title">Coding Agent</h1><p>По умолчанию агент работает в собственной папке задачи. Файлы проекта передаются только как явно указанный контекст и никогда не монтируются в контейнер напрямую.</p></div>
